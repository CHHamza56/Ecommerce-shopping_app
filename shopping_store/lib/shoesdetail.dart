// ignore_for_file: camel_case_types, prefer_interpolation_to_compose_strings, avoid_print, use_build_context_synchronously, unused_import, non_constant_identifier_names, sized_box_for_whitespace
import 'dart:convert';

import 'package:shopping_store/address.dart';
import 'package:shopping_store/cart.dart';
import 'package:shopping_store/shoescart.dart';
  ...
  Future _insertData() async {
    try {
      var res = await http.post(
        Uri.parse(
            "https://apptocoder.com/CsHamza/shoppingProject/addcartshoes.php"),
        body: {
          "img1": widget.img1,
          "name": widget.name,
          "price": widget.price,
        ...
        var snackBar = SnackBar(
          ...
          action: SnackBarAction(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => shoescart()),
              );
            },
          ),
        );
