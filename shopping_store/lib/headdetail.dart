// ignore_for_file: camel_case_types, sized_box_for_whitespace, prefer_interpolation_to_compose_strings, non_constant_identifier_names, use_super_parameters, avoid_print, use_build_context_synchronously, unused_import
import 'dart:convert';
import 'package:shopping_store/address.dart';
import 'package:shopping_store/headcart.dart';
...
class headdetail extends StatefulWidget {
  ...
  @override
  State<headdetail> createState() => _headdetailState();
}
  ...
  Future _insertData() async {
    try {
      var res = await http.post(
        Uri.parse("https://apptocoder.com/CsHamza/shoppingProject/head.php"),
        body: {
          "img1": widget.img1,
          "name": widget.name,
          "price": widget.price,
        ...
        var snackBar = SnackBar(
          ...
          action: SnackBarAction(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => headcart()),
              );
            },
          ),
        );
