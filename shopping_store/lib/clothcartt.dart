...
class clothcartt extends StatefulWidget {
  const clothcartt({super.key});
  @override
  State<clothcartt> createState() => _clothcarttState();
}

class _clothcarttState extends State<clothcartt> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.post(
        Uri.parse(
            "https://apptocoder.com/CsHamza/shoppingProject/clothedetail.php"),
        body: {"uid": "1"},
      );
  ...
  Future<void> removecart(String id) async {
    try {
      final response = await http.post(
        Uri.parse(
            "https://apptocoder.com/CsHamza/shoppingProject/clothdel.php"),
        body: {"id": id},
      );
      setState(() {
        data.clear();
