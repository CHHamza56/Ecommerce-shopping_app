// ignore_for_file: camel_case_types, sized_box_for_whitespace, prefer_interpolation_to_compose_strings, non_constant_identifier_names, use_super_parameters, avoid_print, use_build_context_synchronously
import 'dart:convert';
  ...
  Future _insertData() async {
    try {
      var res = await http.post(
        Uri.parse("https://apptocoder.com/CsHamza/shoppingProject/Addcart.php"),
        body: {
          "img1": widget.img1,
          "name": widget.name,
          "price": widget.price,
